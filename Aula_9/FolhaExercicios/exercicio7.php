...
<body>
    ...
    <p>Sabendo que esse carro custa R$ 22.500,00 à vista, mas foi pago em 60 parcelas de R$ 489,65. Deseja calcular o JUROS?</p>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        require_once 'funcoes_exercicio7.php';
